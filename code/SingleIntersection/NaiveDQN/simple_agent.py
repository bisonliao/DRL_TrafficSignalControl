        ...
        if mode == "train":
            ...
            for episode in range(episodes):
                ...
                while True:
                    ...
                    if self.env.total_step % 117 == 7:
                        self.writer.add_scalar('train/step_reward', reward, self.env.total_step)
                ...
                # 定期保存模型
                if episode % 25 == 1:
                    self.save_checkpoint(f'{episode}_{total_reward}')
            ...
            self.load_checkpoint('./checkpoints/dqn_checkpoint_149_-5373.30029296875.pth')
            self.model.eval()
